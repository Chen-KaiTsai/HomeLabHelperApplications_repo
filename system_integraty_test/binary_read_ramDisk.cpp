...
int main()
{
    ...
    while (true)
    {
	    ...
	    std::cout << "Number of thread invoked: " << omp_get_num_threads() << std::endl;
            #pragma omp section
            {
                std::ifstream inputfile("/mnt/tmpfs/file_check0.bin");
            ...
            #pragma omp section
            {
                std::ifstream inputfile("/mnt/tmpfs/file_checkF.bin");
            ...
            #pragma omp section
            {
                std::ifstream inputfile("/mnt/tmpfs/file_check5.bin");
            ...
            #pragma omp section
            {
                std::ifstream inputfile("/mnt/tmpfs/file_checkA.bin");
